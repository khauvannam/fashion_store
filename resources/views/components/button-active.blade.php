...
@php
    $classes = ($active ?? false)
                ? 'px-4 py-2 bg-black text-white text-sm font-medium leading-5 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition duration-150 ease-in-out'
